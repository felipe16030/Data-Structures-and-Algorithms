...
public class ArcWandMinHeapTests {
    ...
    private static final int LONGTIMEOUT = TIMEOUT * 15;
    ...
    private void printDiff(String method, ArrayList<Integer> diff) {
        ...
        for (int i = 0; i < diff.size() && i < 5; i++) {
            System.out.printf("Index %d: %d, parent at %d: %d%n", diff.get(i), heapArray()[diff.get(i)], diff.get(i)/2, heapArray()[diff.get(i)/2]);
        }
    }
    ...
    public void test_Full_Send_Random_add_remove_cycle() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            ArrayList<Integer> diff = new ArrayList<>();
            if (!isHeap(heapArray(), diff)) {
                printDiff("test_Full_Send_Random_add_remove_cycle", diff);
                assertTrue("Not a heap!", false);
            }
        }
    }
    ...
    public void test_Full_Send_Random_add_clear_cycle() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            ArrayList<Integer> diff = new ArrayList<>();
            if (!isHeap(heapArray(), diff)) {
                printDiff("test_Full_Send_Random_add_clear_cycle", diff);
                assertTrue("Not a heap!", false);
            }
        }
    }
    ...
    public void test_Full_Send_Random_add_remove_add_clear_cycle() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            ArrayList<Integer> diff = new ArrayList<>();
            if (!isHeap(heapArray(), diff)) {
                printDiff("test_Full_Send_Random_add_remove_add_clear_cycle", diff);
                assertTrue("Not a heap!", false);
            }
    ...
    public void test_Full_Send_Random_add_clear_add_remove_cycle() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            ArrayList<Integer> diff = new ArrayList<>();
            if (!isHeap(heapArray(), diff)) {
                printDiff("test_Full_Send_Random_add_clear_add_remove_cycle", diff);
                assertTrue("Not a heap!", false);
            }
    ...
    public void test_Full_Send_Random_add_remove_Full() {
        ...
        for (int i = 0; i < 500; i++) {
            ...
            ArrayList<Integer> diff = new ArrayList<>();
            if (!isHeap(heapArray(), diff)) {
                printDiff("test_Full_Send_Random_add_remove_Full", diff);
                assertTrue("Not a heap!", false);
            }
        }
    }
    ...
    public void test_Full_Send_Random_add_clear_Full() {
        ...
        for (int i = 0; i < 500; i++) {
            ...
            ArrayList<Integer> diff = new ArrayList<>();
            if (!isHeap(heapArray(), diff)) {
                printDiff("test_Full_Send_Random_add_clear_Full", diff);
                assertTrue("Not a heap!", false);
            }
        }
    }
